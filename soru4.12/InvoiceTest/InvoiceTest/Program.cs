...
public class Program
{
    public static void Main()
    {
        ...
        string invoiceID = "C:\\vstudioprojects\\InvoiceTest\\invoice" + DateTime.Now.ToString("yyyyMMdd_HHmmss");
        ...
        if (bought) // An invoice file will be generated if anything is sold.
        {
            ...
            iTextSharp.text.Image png = iTextSharp.text.Image.GetInstance("C:\\vstudioprojects\\InvoiceTest\\Picture1.png");

            //Resize image depend upon your need

            png.ScaleToFit(400f, 80f);

            png.SpacingAfter = 1599f;
            ...
            iTextSharp.text.Paragraph blank = new iTextSharp.text.Paragraph(" ");

            theReport.Add(new Paragraph(blank));
